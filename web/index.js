...
// ── Example sources ───────────────────────────────────────────────────────────
const ISO_SOURCE = `from core import pressed, set_sprite, set_bg_tile, Button
...
const DEMO_SOURCES = { "hello.s": HELLO_SOURCE, "iso.s": ISO_SOURCE, "pong.s": PONG_SOURCE, "platformer.s": PLATFORMER_SOURCE, "rpg.s": RPG_SOURCE };
