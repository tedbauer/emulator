...
const WALKER_SOURCE = `from core import pressed, set_sprite, set_bg_tile, Button
...
const DEMO_SOURCES = { "walker.s": WALKER_SOURCE, "hello.s": HELLO_SOURCE, "pong.s": PONG_SOURCE, "platformer.s": PLATFORMER_SOURCE, "rpg.s": RPG_SOURCE };
